...
//   const poolFinish = useSelector(
//     (state) => state.stake.poolFinish,
//     shallowEqual
//   );
//   const userStaked = useSelector(
//     (state) => state.stake.userStaked,
//     shallowEqual
//   );
...
//   return useMemo(() => {
//     return recentLaunchpools.filter(
//       (lp) => userStaked[lp.id] && userStaked[lp.id] !== "0"
//     );
...
//   return Object.values(launchpools).filter(
//     (lp) => lp.tokenAddress === vault.earnedTokenAddress
//   );
// }

const useFilteredPools = (pools) => {
  ...
  //   filteredPools = hideZeroBalances(
  //     filteredPools,
  //     tokens,
  //     recentStakedLaunchpools
  //   );
  // }

  // if (filters.hideZeroVaultBalances) {
  //   filteredPools = hideZeroVaultBalances(
  //     filteredPools,
  //     tokens,
  //     recentStakedLaunchpools
  //   );
