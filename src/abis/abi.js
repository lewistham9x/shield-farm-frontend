...
export const masterChefABI = [
  {
    inputs: [
      ...
      {
        internalType: "address",
        name: "_feeCommissionAddress",
        type: "address",
      },
      { internalType: "address", name: "_feeTreasuryAddress", type: "address" },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "user", type: "address" },
      {
        indexed: true,
        internalType: "address",
        name: "newFeeCommissionAddress",
        type: "address",
      },
    ],
    name: "SetFeeCommissionAddress",
    type: "event",
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "user", type: "address" },
      {
        indexed: true,
        internalType: "address",
        name: "newFeeTreasuryAddress",
        type: "address",
      },
    ],
    name: "SetFeeTreasuryAddress",
    type: "event",
  },
  {
    anonymous: false,
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_newStartBlock", type: "uint256" },
    ],
    name: "setStartBlock",
    outputs: [],
    stateMutability: "nonpayable",
